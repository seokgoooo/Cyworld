		...
		<div class="bookdot">
			...
			<div class="page">
						...
						<div class="home_contents">
							...
							<div class="updated_news_contents">
								...
								<div class="updated_news_left">
									...
									<span class="updated_news_left1"> <!-- 다이어리 페이지로 이동하는 태그 -->
										<a href="../diary/diary.do"> <span
											class="updated_news_red">&nbsp;다이어리&nbsp;</span> ${diary}
									</a></span>
									<!-- 사진첩에서 가장 최근에 등록된 글을 띄어줌 -->
									<span class="updated_news_left2"> <!-- 사진첩 페이지로 이동하는 태그 -->
										<a href="../photo/photo.do"><span
											class="updated_news_blue">&nbsp;사진첩&nbsp;</span> ${photo }</a></span>
									<!-- 방명록에서 가장 최근에 등록된 글을 띄어줌 -->
									<span class="updated_news_left3"> <!-- 방명록 페이지로 이동하는 태그 -->
								...
								<div class="updated_news_right">
									...
									<div class="updated_news_right1">
										다이어리 <span class="updated_news_right_number">${dcount}
											개</span> &emsp;&emsp;&emsp;&emsp;
										<!-- 사진첨의 총 개수를 출력 -->
				...
				<div class="menu_bar">
					...
					<!-- 방명록 페이지로 이동 -->
					<a href="<%=request.getContextPath()%>/visit/visit.do"
