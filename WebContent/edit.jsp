				...
				<div class="home">
					<div class="upside">
						...
						<form action="edit.do" id="editform" method="POST">
							<input type="text" name="title" value="${ authUser.title }">
							<a href="javascript:{}"
								onclick="document.getElementById('editform').submit();"> <span
								class="updated_news_blue" style="float: right">&nbsp;SUBMIT&nbsp;</span>
							</a>
						</form>
