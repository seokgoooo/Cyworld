...
public class Visitor {
	...
	public Visitor(Integer content_num, Integer user_num, String content, String content_regdate,
			String content_moddate) {
	...
	public Visitor(Integer content_num, Integer user_num, String content, String content_regdate,
			String content_moddate, String name, Owner owner) {
		this.content_num = content_num;
		this.user_num = user_num;
		this.content = content;
		this.content_regdate = content_regdate;
